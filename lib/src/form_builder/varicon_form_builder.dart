...
//     questionNumber = 1;
//     return Scaffold(
//       bottomNavigationBar: _NavigationButton(
//         buttonText: widget.buttonText,
//         onComplete: () async {
//           var i = _field;

//           var mediaInputTypeStatus = widget.surveyForm.inputFields
//               .firstWhere((test) => test.isRequired == true);
//           // return if form state is null.
//           if (formKey.currentState == null) return;
//           // return if form is not valid.
//           if (!formKey.currentState!.validate() || (_field == null)) {
//             for (int i = 0; i < _fieldKeys.length; i++) {
//               FocusScope.of(context).requestFocus(FocusNode());
...
//               });
//               final fieldKey = _fieldKeys[i];
//               if ((fieldKey.currentState != null) || _field == null) {
//                 if (!(fieldKey.currentState!.validate()) || _field == null) {
//                   print('Field at index $ind has a validation error!');
...
//                     initialScrollIndex: errorOnIndex,
//                     // minCacheExtent: ,
