...
import 'package:example/theme/app_text_style.dart';
...
class AppTheme {
  static final defaultTheme = ThemeData(
    ...
    textTheme: TextTheme(
      headline1: AppTextStyle.displayLarge,
      headline2: AppTextStyle.displayMedium,
      headline3: AppTextStyle.displaySmall,
      headline4: AppTextStyle.headlineMedium,
      headline5: AppTextStyle.headlineSmall,
      headline6: AppTextStyle.titleLarge,
      subtitle1: AppTextStyle.titleMedium,
      subtitle2: AppTextStyle.titleSmall,
      bodyText1: AppTextStyle.bodyLarge,
      bodyText2: AppTextStyle.bodyMedium,
      button: AppTextStyle.labelLarge,
      caption: AppTextStyle.bodySmall,
      overline: AppTextStyle.labelSmall,
    ),
